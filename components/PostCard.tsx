  ...
  return (
    ...
    >
      <div className="flex flex-col justify-between h-full">
        ...
        <div className="absoulte border group-hover:border-slate-900/20 group-hover:dark:border-slate-50/10 border-transparent -mt-0.5 transition-colors duration-300" />
